...
def test(model_dir, cnt_round, cnt_gen, run_cnt, _dic_traffic_env_conf, dic_agent_conf, dic_exp_conf, config, if_gui, q):
    ...
    env = TSCSimulator(config, config['port_start'] + cnt_gen)
